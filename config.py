...
modelSavePath = '/data/shenzhonghai/FaceClustering/models/Vgg16_mtwf_base_3|100k_ep'
# test
...
modelPath = '/data/shenzhonghai/FaceClustering/models/nVgg16_mtwf_base_3|100k_ep0.pt'
